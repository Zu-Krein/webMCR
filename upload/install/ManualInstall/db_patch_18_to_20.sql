...
ALTER TABLE `accounts` DROP `ip`;
ALTER TABLE `accounts` ADD `ip` binary(16) NOT NULL;

ALTER TABLE `ip_banning` DROP `IP`;
ALTER TABLE `ip_banning` ADD `IP` binary(16) NOT NULL;
